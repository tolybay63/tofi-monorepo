...
export default {
  ...
  appCalcName: 'Қорларды және рұқсат етілген шекті деңгейлерді есептеу',
  ...
  selectedCalc: 'Таңдалған есептеу',
  nameCalc: 'Есептеу атауы',
  calc: 'Есептеу',
  ...
  samplingStations: 'Сынама алу және балық аулау станциялары',
