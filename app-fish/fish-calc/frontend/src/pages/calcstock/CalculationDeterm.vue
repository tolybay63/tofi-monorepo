<template>
  <q-banner class="bg-green-1" dense inline-actions>
    <div class="row">
      <div style="font-size: 1.2em; font-weight: bold">
        ...
        {{ title }} <span class="text-caption text-orange">({{ proxy?.$t("calcDeterm") }})</span>
      </div>
      <q-space/>
  ...
  <h1 class="absolute-center"> Интерфейс детерминированного расчета</h1>
...
const toBack = () => {
  router["push"]({name: 'CalcStockDeterm'})
}
